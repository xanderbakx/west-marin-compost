  ...
  render() {
    return (
      <Section>
        <Title message="" title="" />
        <FaqContentWrapper>
          <h3 style={{ paddingTop: '2rem' }}>How is compost made?</h3>
          ...
          <h3 style={{ paddingTop: '2rem' }}>What about noxious or diseased weeds?</h3>
          <p className="text">WMC does accept almost all “weeds.” Most weeds and weed seeds are destroyed by the high temperatures of the thermophilic composting process.  One notable exception is the seeds of common garden morning glory (Convolvulus arvensis), which have been shown to survive temperatures of up to 180 F. Consequently, we do not accept this material at the drop off site. Some plant species do not like to be ground like bamboo and palm. While the irritant of poison oak breaks down in the composting process, until then it can cause our employees to be affected by poinson oak. Most other plant material is accepted. Clopyralid, a broadleaf herbicide, does not break down in a timely manner. Green material and manures that contain clopyralid are not allowed.</p>

          <h3 style={{ paddingTop: '2rem' }}>Why is compost better than liquid manures?</h3>
