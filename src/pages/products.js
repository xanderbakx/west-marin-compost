  ...
  <StaticQuery query={graphql`
      {
        ...
        amendedSoil: file(relativePath: {eq: "compostProducts.png"}) {
          childImageSharp {
            fluid(maxWidth: 1600) {
              ...GatsbyImageSharpFluid
            }
        ...
        <ProductsWrapper>
          <Accordion>
            <CompostItem
              ...
              price="$20.00/yd3 (20+ yd3 $18.00/yd3)"
            />
            <CompostItem
              image={data.hiTest}
            ...
            <CompostItem
              ...
              price="$18.00/yd3(20+ yd3$16.00/yd3)"
            />
            <CompostItem
            ...
            <CompostItem
              ...
              description="Oyster shell willhelp some clay soils in improving drainage.  It also helps neutralize soil pH.Oyster shell will enhance plant growth and make plants stronger."
              price="$200/yd3"
            />
          </Accordion>
